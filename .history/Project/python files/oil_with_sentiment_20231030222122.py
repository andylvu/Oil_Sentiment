...
df = pd.read_csv('c:\Users\Andy\Documents\vscode\Machine_Learning\Project\datasets\oil_final2.csv', index_col="Date", infer_datetime_format=True, parse_dates=True)
